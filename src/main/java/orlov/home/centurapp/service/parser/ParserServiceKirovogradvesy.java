...
public class ParserServiceKirovogradvesy extends ParserServiceAbstract {
    ...
    public ParserServiceKirovogradvesy(AppDaoService appDaoService, OpencartDaoService opencartDaoService, ScraperDataUpdateService scraperDataUpdateService, TranslateService translateService, FileService fileService, UpdateDataService updateDataService) {

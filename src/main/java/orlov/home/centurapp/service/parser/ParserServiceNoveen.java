...
public class ParserServiceNoveen extends ParserServiceAbstract {
    ...
    public ParserServiceNoveen(AppDaoService appDaoService, OpencartDaoService opencartDaoService, ScraperDataUpdateService scraperDataUpdateService, TranslateService translateService, FileService fileService) {

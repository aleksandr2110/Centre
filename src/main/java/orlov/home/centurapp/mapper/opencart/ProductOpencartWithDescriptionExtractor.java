...
public class ProductOpencartWithDescriptionExtractor implements ResultSetExtractor<ProductOpencart> {
    @Override
    public ProductOpencart extractData(ResultSet rs) throws SQLException, DataAccessException {
        ...
        while (rs.next()){
            ...
            product.setProductsDescriptionOpencart(Collections.singletonList(desc));
        }
